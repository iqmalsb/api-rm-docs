...
<ParamTable
  ...
  rows={[
    ...
    { name: "faceResult", type: "Object", description: "Refer to the Face Result", example: "(Refer to explanation below)" },
    ...
    { name: "results", type: "Array", description: "Refer to the EKYC Result", example: "(Refer to explanation below)" },
